...
*srvio* is a responsive mobile-first layouts as web-based platform that connects users with local service providers 
...
## UI/UX Design with (Dark + Light) toggle Theme.
Design a premium modern SaaS web application and landing page inspired by the visual style, spacing, typography, gradients, 
and futuristic feel of modern AI/SaaS products.
...
Create a sleek AI-native SaaS experience with:
...
Secondary Accent Cyan: #38DDF8
Gradient Accent: linear-gradient(135deg, #4F8CFF 0%, #38DDF8 100%)
Glow Accent: rgba(79,140,255,0.35)
Text Colors (Dark)
Primary Text: #FFFFFF
Secondary Text: #B8C2D9
Muted Text: #7C8AA5
Light Mode

IMPORTANT:
The light mode must maintain strong contrast and readability while preserving the same premium SaaS feel.

Backgrounds
Main Background: #F7F9FC
Secondary Background: #EEF3FA
Surface/Card: #FFFFFF
Borders
...
Medium font weights for UI labels
